...
# Function Name:
funct_name = r'MAT2_2024T4_REFINED2'
material_string = '2024-T4 Aluminum'
color = 'red'

# Array defining training grid (Typically generated using np.linspace()):
H_ss = np.array([480, 506.67, 533.33, 560, 586.67, 613.33, 640, 666.67, 693.33, 720, 746.67, 773.33, 800, 826.67, 853.33, 880, 906.67, 933.33, 960, 986.67, 1013.33, 1040, 1066.67, 1093.33, 1120])
n_ss = np.array([0.120, 0.127, 0.133, 0.140, 0.147, 0.153, 0.160, 0.167, 0.173, 0.180, 0.187, 0.193, 0.200, 0.207, 0.213, 0.220, 0.227, 0.233, 0.240, 0.247, 0.253, 0.260, 0.267, 0.273, 0.280])
problem_iterations = [180, 295, 622]
