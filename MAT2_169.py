...
analysis_call: list {   'MULTIMODEL_ANALYSIS', 'ONEGAMMA_ANALYSIS', 'HN_INCLUSION_ANALYSIS',
                        'PREDICTION_BOOSTING', 'XGBOOST', 'FEATURE_REDUCTION', 3MATERIAL_RESULTS}
...
# Function Name:
funct_name = r'MAT2_2024T4_REFINED1'
material_string = '2024-T4 Aluminum'
color = 'red'

# Array defining training grid (Typically generated using np.linspace()):
H_ss = np.array([480, 533.33, 586.67, 640, 693.33, 746.67, 800, 853.33, 906.67, 960, 1013.33, 1066.67, 1120])
n_ss = np.array([0.120, 0.133, 0.147, 0.160, 0.173, 0.187, 0.200, 0.213, 0.227, 0.240, 0.253, 0.267, 0.280])
problem_iterations = [167]
