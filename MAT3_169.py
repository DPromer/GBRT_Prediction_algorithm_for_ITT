...
# Function Name:
funct_name = 'MAT3_1020SAE_REFINED1'
material_string = '1020 SAE (Hot-Rolled)'
color = 'blue'

# Array defining training grid (Typically generated using np.linspace()):
H_ss = np.array([450,  500,  550,  600,  650,  700,  750,  800,  850,  900,  950, 1000, 1050])
n_ss = np.array([0.115, 0.1275, 0.140, 0.1525, 0.165, 0.1775, 0.190, 0.2025, 0.215, 0.2275, 0.240, 0.2525, 0.265])
problem_iterations = [0, 156, 157]
