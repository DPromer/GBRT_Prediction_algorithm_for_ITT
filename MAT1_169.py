...
# Function Name:
funct_name = r'MAT1_7075T6_REFINED1'
material_string = '7075-T6 Aluminum'
color = 'black'

# Array defining training grid (Typically generated using np.linspace()):
H_ss = np.array([500,  554.17, 608.33, 662.50, 716.67, 770.83, 825,  879.17, 933.33, 987.50, 1041.67, 1095.83, 1150])
n_ss = np.array([0.068, 0.0755, 0.083, 0.0905, 0.098, 0.1055, 0.113, 0.1205, 0.128, 0.1355, 0.143, 0.1505, 0.158])
problem_iterations = []
