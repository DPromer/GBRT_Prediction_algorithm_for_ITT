...
analysis_call: list {   'MULTIMODEL_ANALYSIS', 'ONEGAMMA_ANALYSIS', 'HN_INCLUSION_ANALYSIS',
                        'PREDICTION_BOOSTING', 'XGBOOST', 'FEATURE_RECUTION'}
    What portions of the machine-learning analysis should be completed?
"""
plotting_on = 'T'
analysis_call = ['3MATERIAL_RESULTS', 'HN_INCLUSION_ANALYSIS']
# Function Name:
funct_name = r'MAT1_7075T6_REFINED2'
material_string = '7075-T6 Aluminum'
color = 'black'
# Array defining training grid (Typically generated using np.linspace()):
H_ss = np.array([500, 527.08, 554.17, 581.25, 608.33, 635.41, 662.50, 689.58, 716.67, 743.75, 770.83, 797.92, 825, 852.08, 879.17, 906.25, 933.33, 960.42, 987.50, 1014.58, 1041.67, 1068.75, 1095.83, 1122.92, 1150])
n_ss = np.array([   0.068  , 0.07175, 0.0755 , 0.07925, 0.083  , 0.08675, 0.0905 ,
                    0.09425, 0.098  , 0.10175, 0.1055 , 0.10925, 0.113  , 0.11675,
                    0.1205 , 0.12425, 0.128  , 0.13175, 0.1355 , 0.13925, 0.143  ,
                    0.14675, 0.1505 , 0.15425, 0.158  ])
problem_iterations = [401]
